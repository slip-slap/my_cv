...
\node[left=0.0cm] at (current page.28){
    \includegraphics[width=3.5cm]{./wuxi.png}
};
...
\addtobeamertemplate{frametitle}{}{
	\begin{textblock*}{15mm}(0.86\textwidth,-1.1cm)
		\includegraphics[width=2.5cm]{./kit_wuxi_logo.png}
	\end{textblock*}
	}	
...
\begin{textblock*}{2cm}(5.8cm,-1.9cm) % {block width} (coords)
	\includegraphics[width=6.0cm]{./last_wuxi_logo.png}
\end{textblock*}
	...
	\begin{tikzpicture}
		...
		\node at (8,6) {\textcolor{blue}{\Huge{请各位老师批评指正
			}} };
		\node at (8,4) {\textcolor{blue}{\Huge{邮箱:
			zhanghuiyao2357@163.com}} };
		\end{scope}
	\end{tikzpicture}
\end{frame}

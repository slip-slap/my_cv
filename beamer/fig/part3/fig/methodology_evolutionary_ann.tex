...
\end{tikzpicture}
%}
\caption{A general framework for evolutionary artificial neural network, in
which fitness refers to the corresponding value of an objective function.\cite{yao1999evolving}}
\label{fig:evolution}
\end{figure}
